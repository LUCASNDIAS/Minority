...
namespace backend\modules\pessoas\controllers;

use Yii;
use backend\modules\pessoas\models\Pessoas;
use backend\modules\pessoas\models\PessoasSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for Pessoas model.
 */
