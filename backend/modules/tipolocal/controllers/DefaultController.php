...
namespace backend\modules\tipolocal\controllers;

use Yii;
use backend\modules\tipolocal\models\Tipolocal;
use backend\modules\tipolocal\models\TipolocalSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for Tipolocal model.
 */
class DefaultController extends Controller
{
    ...
    {
        if (($model = Tipolocal::findOne($id)) !== null) {
            return $model;
        } else {
